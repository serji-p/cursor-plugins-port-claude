...
# Final Response
IF you have medium-to-high priority / risk findings, and there is a PR for this branch, then check the PR/MR discussion using the `gh` (GitHub) or `glab` (GitLab) CLI to see if there are comments from review bots or others present.
...
Flag issues found by review bots or others in the PR/MR discussion that you include in your report.
