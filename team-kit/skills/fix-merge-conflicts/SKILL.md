...
description: Resolve merge conflicts non-interactively, validate build and tests, and finalize conflict resolution. Use when a rebase or merge left conflict markers, "fix the conflicts", or a branch won't merge cleanly.
---
