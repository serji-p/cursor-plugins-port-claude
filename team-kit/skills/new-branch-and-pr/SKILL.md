...
description: Create a fresh branch, complete work, and open a pull request. Use when starting a change that should ship through a clean branch + PR workflow, or "open a PR for this".
---
...
5. Create a concise PR with summary and test notes (`gh pr create`).
