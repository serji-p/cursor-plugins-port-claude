...
description: Summarize authored commits over a user-specified time period into a concise update. Use for "what did I get done", "summarize my work since yesterday/last week", or building a quick status update from git history.
---
...
2. Read commits authored by the current git user email within that range (`git log --author="$(git config user.email)" --since=... --until=...`).
