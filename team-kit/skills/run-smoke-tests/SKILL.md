...
description: Run Playwright smoke tests, debug failures, and verify fixes. Use for end-to-end smoke verification before or after a change, "run the smoke tests", or triaging a flaky e2e suite.
---
...
> Adapt the script names to the current repo's `package.json` — the commands above are common conventions, not guarantees.
